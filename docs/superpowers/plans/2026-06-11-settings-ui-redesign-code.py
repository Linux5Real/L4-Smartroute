...
:root{
  ...
  --accent:#2dd4bf;--accent-dim:rgba(45,212,191,0.08);--accent-medium:rgba(45,212,191,0.18);
...
.section{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:24px;margin-bottom:16px;animation:fadeUp 400ms ease both}
...
.mode-card{border:1.5px solid var(--border);border-radius:var(--radius-sm);padding:16px 14px;cursor:pointer;transition:all 150ms ease;text-align:center;background:transparent}
.mode-card:hover{border-color:var(--border-hover);background:var(--surface-raised)}
.mode-card.active{border-color:var(--accent);background:var(--accent-dim)}
.mode-card .mode-icon{width:32px;height:32px;margin:0 auto 10px;color:var(--text-secondary);transition:color 150ms}
...
.router-option{display:flex;align-items:flex-start;gap:12px;padding:14px 16px;border:1.5px solid var(--border);border-radius:var(--radius-sm);cursor:pointer;transition:all 150ms ease;background:transparent}
.router-option:hover{border-color:var(--border-hover);background:var(--surface-raised)}
.router-option.active{border-color:var(--accent);background:var(--accent-dim)}
...
.tag{display:inline-block;font-size:10px;font-weight:500;padding:1px 6px;border-radius:4px;background:var(--accent-dim);color:var(--accent);vertical-align:middle;margin-left:4px}
...
.search-input{padding:6px 12px;background:var(--bg);border:1px solid var(--border);border-radius:var(--radius-xs);color:var(--text);font-family:var(--font);font-size:12px;width:180px;transition:border-color 150ms}
...
.filter-chip{padding:4px 12px;border:1px solid var(--border);border-radius:20px;font-size:11px;font-weight:500;cursor:pointer;background:transparent;color:var(--text-secondary);transition:all 150ms;font-family:var(--font)}
.filter-chip:hover{border-color:var(--text-tertiary);color:var(--text)}
...
.model-card{display:flex;align-items:flex-start;gap:10px;padding:10px 12px;border:1px solid var(--border);border-radius:var(--radius-xs);cursor:pointer;transition:all 150ms;background:transparent}
.model-card:hover{border-color:var(--border-hover);background:var(--surface-raised)}
...
.form-group input,.form-group select{width:100%;padding:8px 12px;background:var(--bg);border:1px solid var(--border);border-radius:var(--radius-xs);color:var(--text);font-family:var(--font);font-size:13px;transition:border-color 150ms}
...
.btn{padding:7px 16px;border-radius:var(--radius-xs);font-size:12px;font-weight:500;cursor:pointer;border:1px solid var(--border);background:transparent;color:var(--text-secondary);font-family:var(--font);transition:all 150ms}
...
function renderModels() {
  ...
  filtered.forEach(function(m) {
    ...
    cb.onclick = function(e) { e.stopPropagation(); toggleModel(m.id); };
